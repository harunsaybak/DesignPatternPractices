...
[TestClass]
public class SerializationInterfaceFixture
{
    [TestMethod]
    public void Test()
    {
        ...
        var graph = SerializationHelper.SerializeObjectToString(user1);
        var user2 = SerializationHelper.DeserializeStringToObject<UserInfo>(graph);
